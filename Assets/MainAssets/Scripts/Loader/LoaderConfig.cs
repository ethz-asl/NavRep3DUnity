...
static class LoaderConfig
{
    ...
    #region get_set
    public static string currentTrialName { get { return trialData.TrialsList[xpCurrentTrial]; } }
    // User
    ...
    public static List<CustomXmlSerializer<TrialObstacle>> obstaclesInfo    { get { return trialData.currentTrial.obstacles; } }
    // Record data
