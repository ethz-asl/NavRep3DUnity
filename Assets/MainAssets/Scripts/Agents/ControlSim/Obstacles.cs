...
namespace CrowdMP.Core
{
    public class Obstacles
    {
        ...
        List<ObstWall> walls;
        List<ObstWall> robotOnlyWalls;

        public Obstacles()
        {
            pillars = new List<ObstCylinder>();
            walls = new List<ObstWall>();
            robotOnlyWalls = new List<ObstWall>();
        }
        ...
        public void addRobotOnlyWall(GameObject wall)
        {
            ...
            robotOnlyWalls.Add(new ObstWall(p1, p2, p3, p4));
        }

        public List<ObstCylinder> Pillars { get { return pillars; } }
        public List<ObstWall> Walls { get { return walls; } }
        public List<ObstWall> RobotOnlyWalls { get { return robotOnlyWalls; } }
    }
