...
public class RotateJoints : MonoBehaviour
{
    ...
    void Start()
    {
        Base = transform.Find("pepper").Find("Base");
        Knee = Base.Find("Knee");
        Hip = Knee.Find("Upper leg").Find("Hip");
        Head = Hip.Find("Torso").Find("Head");
        LShoulder = Hip.Find("Torso").Find("L Arm").Find("L Shoulder");
        LElbow = LShoulder.Find("L Upper arm").Find("L Elbow");
        LWrist = LElbow.Find("L Forearm").Find("L Wrist");
        RShoulder = Hip.Find("Torso").Find("R Arm").Find("R Shoulder");
        RElbow = RShoulder.Find("R Upper arm").Find("R Elbow");
        RWrist = RElbow.Find("R Forearm").Find("R Wrist");
    ...
    void Update()
    {
        ...
        Knee.localEulerAngles = new Vector3(0.0f, 0.0f, KneePitch);
